...
// //show intro
// $show_intro_text = ($params->get('show_intro')) ? 'show-intro' : 'hide-intro' ;
...
<div class="entry-info-wrap">
	...
	<div class="entry-header<?php echo $tpl_params->get('show_post_format') ? ' has-post-format': ''; ?>">
		...
		<?php if ($useDefList && ($info == 0 || $info == 2)) : ?>
			<?php echo JLayoutHelper::render('joomla.content.info_block.list_block', array('item' => $this->item, 'params' => $params, 'position' => 'above' )); ?>
		<?php endif; ?>
	...
	<?php if ($tpl_params->get('blog_list_introtext')): ?>

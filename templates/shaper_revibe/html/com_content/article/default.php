...
$useDefList = ($params->get('show_modify_date') || $params->get('show_publish_date') || $params->get('show_create_date')
	...
	$show_social_share = $tpl_params->get('social_share', 0);
...
?>
	...
	<?php if ( isset($show_social_share) && $show_social_share) {
		echo JLayoutHelper::render('joomla.content.social_block', $this->item);
	} ?>
